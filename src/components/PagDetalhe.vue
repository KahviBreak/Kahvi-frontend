    ...
    <div class="container">
      ...
      <div class="containerDetalhes">
        ...
        <div class="container-quant">
          <div class="quantidade">
            ...
            <div class="quantButton">
              ...
              <button class="quantity-button" @click="aumentarQuantidade"
                :disabled="quantity >= product.inStock">+</button>
            </div>
          </div>
          <div class="graos">
        ...
        <div class="observacao-div">
          <label class="obs"><svg width="18" height="17" viewBox="0 0 18 17" fill="none"
          ...
          <input id="observacao" type="text" placeholder="Ex: tirar azeitona, milho etc.">
        </div>
        <div class="botoes">
          <div>
...
input[type="text"] {
  ...
  height: 49px;
  background: #FFFFFF;
  border:0.5px solid #C1B8B0;  margin-top: 0;
  border-radius: 4px;
  padding: 0;
}
